/* ═══════════════════════════════════════════════════════════════════════
   COVERAGE VAULT — Storefront JavaScript
...
(function () {
  ...
  const leadForms = document.querySelectorAll('.lm-form');
  ...
  leadForms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      // Placeholder: In production, this would submit to an email service
  ...
  if ('IntersectionObserver' in window) {
    var animateTargets = document.querySelectorAll(
      '.product-card, .bundle-card, .feature-card, .lead-magnet-card, .cross-sell-card, .faq-item'
    );
